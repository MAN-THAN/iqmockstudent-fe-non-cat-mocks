...
function Terms() {
  ...
  return (
    <div
      className="container d-flex-col justify-content-center align-content-center"
          ...
          >
            ...
            >
              <Typography variant="text"  >
                Every company that manufactures and sells products uses this
                clause to limit what customers can hold them accountable for.
              </Typography>
              <br /> <br />
              <Typography variant="text" >
              ...
              <div className="ps-3">
                <ul style={{ listStylePosition: "outside", paddingLeft: "0px" }}>
                  ...
                  <li>
                    <Typography variant="text">
                      Lack of enjoyment, since it's subjective and prone to
                      change.
                    </Typography>
                  </li>
                  <li>
                  ...
                  <li>
                    <Typography variant="text">
                      Modifications and interruptions - while you can include
                      them as a separate clause as covered below, many companies
                      choose to have it as part of their limitation of liability
                      and warranty clause
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="text">
                      Errors and inaccuracies - as with modifications and
                      interruptions, you can choose to include errors and
                      inaccuracies in a separate "corrections" section. However,
                      most companies choose to include it under this clause.
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="text">
