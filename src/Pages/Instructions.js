      ...
      <div className="container border-2 mt-4 p-2 text-center ">
        ...
        >
          ...
          <ol className="fw-bold">
              ...
              <ul className="list-unstyled">
                ...
                <li>
                  <div className="d-flex align-items-center pt-3">
                    ...
                    <Typography variant="paragraph" className="text-start">
                      {" "}
                      This question has been answered and will be considered for evaluation
                    </Typography>
                  </div>
                </li>
                <li>
                  ...
                  <div className="d-flex pt-3 align-items-center">
                    ...
                    <Typography variant="paragraph" className="text-start">
                      {" "}
                      This question has been marked for review and has not been answered
                    </Typography>
                  </div>
                </li>
                <li>
                  ...
                  <div className="d-flex  pt-3 align-items-center">
                    ...
                    <Typography variant="paragraph" className="text-start">
                      {" "}
                      This question has been answered and marked for review. This will be considered for evaluation
                    </Typography>
                  </div>
                </li>
                <li className="mt-2">
                  <Typography>
                    The Marked for Review status simply acts as a reminder that you have set to look at the question again. If an answer is selected
                    for a question that is Marked for Review, the answer will be considered in the final evaluation
                  </Typography>
            ...
            <li className="mt-3  ">
              <Typography variant="paragraph">To select a question to answer, you can do one of the following:</Typography>
              <ul className="list-unstyled">
                <li className="mt-2">
                  <Typography>
                    {" "}
                    Click on the question number on the question palette at the right of your screen to go to that numbered question directly. Note
                    that using this option does NOT save your answer to the current question
                  </Typography>
                </li>
                <li className="mt-2">
                  <Typography>
            ...
            <li className="mt-3">
              <Typography variant="paragraph"> You can view the entire paper by clicking on the All Questions button</Typography>
              <ul className="list-unstyled">
                <li>
                  {" "}
                  <Typography sx={{ my: "10px" }}>Answering questions</Typography>
                </li>
              </ul>
            </li>

            <li className="mt-3">
              <Typography variant="paragraph">For multiple choice type question</Typography>
              <ol className="fw-lighter list-inline " style={{ listStyleType: "lower-alpha" }}>
                <li className="mt-2">
                  {" "}
                  <Typography>To select your answer, click on one of the option buttons</Typography>{" "}
                </li>
                <li className="mt-2">
                  <Typography>To change your answer, click the another desired option button</Typography>{" "}
                </li>
                <li className="mt-2">
                  {" "}
                  <Typography>To save your answer, you MUST click on save</Typography>{" "}
                </li>
                <li className="mt-2">
                  {" "}
                  <Typography> To deselect a chosen answer, click on the chosen option again or click on the Clear Response button</Typography>
                </li>
                <li className="mt-2">
                  {" "}
                  <Typography>
                    To mark a question for review click on Mark for Review & Next If an answer is selected for a question that is Marked for Review,
            ...
            <li className="mt-3">
              <Typography variant="paragraph">
                {" "}
                To change an answer to a question, first select the question and then click on the new answer option followed by a click on the save
                button
              </Typography>
            </li>
            <li className="mt-3">
            ...
            <li className="my-3">
              <Typography variant="paragraph">If quiz is paused, quiz can be continued from where left off within scheduled time</Typography>
            </li>
            <Typography sx={{ color: "black" }}>Navigation through sections :</Typography>
            <li className="mt-3">
              <Typography variant="paragraph">
                {" "}
                Sections in this question paper are displayed on the top bar of the screen. Questions in a section can be viewed by clicking on the
            ...
            <li className="mt-3">
              <Typography variant="paragraph">
                {" "}
                After clicking the save button on the last question for a section,you will automatically be taken to the first question of the next
                section{" "}
              </Typography>
            </li>
            <li className="mt-3">
