...
function AnalysisMain() {
  ...
  }, [basicAnalysis, topperData]);
  console.log(air, topperData);
  const { name, negativeMarks, overallPercentage, potentialScore, accuracy, percentile, title, targetPercentile, overallScore } = basicData;
                    ...
                    >
                      <CardContent>
                        ...
                        <div className="d-flex justify-content-between align-items-center mt-2">
                          <img src="/india1.png" alt="india rank icon" className="image-fluid" width={94} />
